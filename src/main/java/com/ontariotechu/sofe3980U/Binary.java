	...
	*/
	...
	public static Binary or(Binary num1, Binary num2) {
        ...
        for (int i = 0; i < bin1.length(); i++) {
            // Perform bitwise OR and append result
    ...
    public static Binary and(Binary num1, Binary num2) {
        ...
        StringBuilder result = new StringBuilder();
        for (int i = 0; i < bin1.length(); i++) {
            // Perform bitwise AND and append result
            result.append((bin1.charAt(i) == '1' && bin2.charAt(i) == '1') ? '1' : '0');
        }
        return new Binary(result.toString());
    }
	...
	public static Binary multiply(Binary num1, Binary num2) {
		...
		// Perform binary multiplication without reversing the strings
		for (int i = 0; i < num2.number.length(); i++) {
			if (num2.number.charAt(num2.number.length() - 1 - i) == '1') {
				// For each 1 in num2, shift num1 by i and add to the result
